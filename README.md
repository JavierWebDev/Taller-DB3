...
(2, 'Cliente 2', 'Apellido3', 'Apellido4', 2, 2, 2, 2, NULL, 2, 2, 2, 2, NULL, 15000),
(3, 'Cliente 3', 'Apellido5', 'Apellido6', NULL, 1, 1, 1, NULL, 1, 1, 3, NULL, NULL, NULL),
...
(1001, '2024-01-01', '2024-01-10', NULL, 1, 'Primer pedido', 1),
(1002, '2024-02-01', '2024-02-10', NULL, 2, 'Segundo pedido', 2),
(1003, '2024-03-01', '2024-03-10', '2024-03-09', 1, NULL, 3),
(1004, '2024-04-01', '2024-04-10', '2024-04-07', 1, 'Pedido anticipado', 1)
(1005, '2024-04-15', '2024-04-20', '2024-04-21', 1, 'Entrega retrasada', 2)
(1006, '2023-01-05', '2023-01-15', '2023-01-10', 1, 'Entrega en enero de 2023', 4);
...
('T001', 1, 1, '2008-01-05', 499.95),
('T002', 2, 2, '2008-02-15', 359.97),
('T003', 3, 3, '2009-03-05', 1949.85),
...
**3.** Devuelve un listado con el nombre, apellidos y email de los empleados cuyojefe tiene un código de jefe igual a 7.
...
```sql
SELECT p.codigo_pedido, p.codigo_cliente_pedido, p.fecha_pedido, p.fecha_esperada, p.fecha_entrega
FROM pedido p
JOIN estado e ON p.estado_pedido = e.id_estado
WHERE e.estado = 'Rechazado' AND YEAR(p.fecha_pedido) = 2009;
+---------------+-----------------------+--------------+----------------+---------------+
| codigo_pedido | codigo_cliente_pedido | fecha_pedido | fecha_esperada | fecha_entrega |
+---------------+-----------------------+--------------+----------------+---------------+
|          1006 |                     3 | 2009-06-15   | 2009-06-20     | NULL          |
+---------------+-----------------------+--------------+----------------+---------------+
```
...
| codigo_pedido | codigo_cliente_pedido | fecha_esperada | fecha_entrega |
+---------------+-----------------------+----------------+---------------+
|          1007 |                     4 | 2023-01-15     | 2023-01-10    |
+---------------+-----------------------+----------------+---------------+
```

**13.** Devuelve un listado con todos los pagos que se realizaron en elaño 2008 mediante Paypal. Ordene el resultado de mayor a menor.
